...
export const translations = {
  en: {
    ...
    'nav.blog': 'Blog',
    'nav.contact': 'Contact',
    'nav.quote': 'Book a Demo',
    'hero.kicker': 'AI SaaS Products',
    'hero.line1': 'We Build.',
    'hero.line2': 'AI Software.',
    'hero.line3': 'For Business Growth.',
    'hero.stat1': 'Years of craft',
    'hero.stat2': 'Products in development',
    'hero.stat3': 'Founder-led execution',
    'hero.desc': 'Devndespro is a Norway-based <strong>AI software company</strong> building two B2B SaaS products: <strong>SEO.devndespro</strong> for search visibility and <strong>Tenderlyst</strong> for tender discovery and RFP workflows.',
    'hero.svc1': 'SEO.devndespro — AI SEO & Search Visibility',
    'hero.svc2': 'Tenderlyst — Tender Discovery & RFP Management',
    'hero.svc3': 'Product Engineering & Cloud',
    'hero.svc4': 'Implementation, Integrations & Growth',
    'hero.primary': 'Explore Products',
    'hero.secondary': 'Book a Demo',
    'hero.explore': 'Explore',
    'cta.mid.title': 'Ready to explore our products?',
    'cta.mid.text': 'Book a focused conversation about SEO visibility, tender workflows, integrations, partnerships, or early access.',
    'cta.mid.primary': 'Book a Product Demo',
    'cta.mid.secondary': 'Explore Products',
    ...
    'contact.label': 'Talk to Devndespro',
    'contact.title': "Let's discuss<br>products, partnerships & <em>growth</em>",
    'contact.whatsapp': 'Message the founder',
    'contact.status': 'Open to pilots, partnerships and investor conversations',
  ...
  no: {
    ...
    'nav.services': 'Løsninger',
    'nav.work': 'Kundecaser',
    'nav.skills': 'Plattform',
    'nav.blog': 'Blogg',
    'nav.contact': 'Kontakt',
    'nav.quote': 'Book en demo',
   'hero.kicker': 'AI SaaS-produkter',
    'hero.line1': 'Vi Bygger.',
    'hero.line2': 'AI-programvare.',
    'hero.line3': 'For Bedrifter i Vekst.',
    'hero.stat1': 'År med erfaring',
    'hero.stat2': 'Produkter under utvikling',
    'hero.stat3': 'Grunnleggerdrevet',
    'hero.desc': 'Devndespro er et norsk <strong>AI-programvareselskap</strong> som utvikler to B2B SaaS-produkter: <strong>SEO.devndespro</strong> for søkesynlighet og <strong>Tenderlyst</strong> for anbudsoppdagelse og RFP-håndtering.',
    'hero.svc1': 'SEO.devndespro – AI SEO og søkesynlighet',
    'hero.svc2': 'Tenderlyst – Anbudsoppdagelse og RFP-håndtering',
    'hero.svc3': 'Produktutvikling og sky',
    'hero.svc4': 'Implementering, integrasjoner og vekst',
    'hero.primary': 'Utforsk Produktene',
    'hero.secondary': 'Book en Demo',
    'hero.explore': 'Utforsk',
    'cta.mid.title': 'Klar til å utforske produktene våre?',
    'cta.mid.text': 'Book en fokusert samtale om SEO-synlighet, anbudsprosesser, integrasjoner, partnerskap eller tidlig tilgang.',
    'cta.mid.primary': 'Book en Produktdemo',
    'cta.mid.secondary': 'Utforsk Produktene',
    ...
    'contact.label': 'Snakk med Devndespro',
    'contact.title': 'La oss snakke om<br>produkter, partnerskap og <em>vekst</em>',
    'contact.whatsapp': 'Send melding til gründeren',
    'contact.status': 'Åpen for piloter, partnerskap og investordialog',
...
export const sectionTranslations = {
  en: {
    servicesLabel: 'Supporting Services',
    servicesHeading: 'Product-led execution<br>from <em>idea to scale</em>',
    servicesNote: 'Our services support our SaaS products and selected client engagements—from UX and product engineering to cloud infrastructure, integrations, SEO, and go-to-market execution.',
    serviceNames: [
